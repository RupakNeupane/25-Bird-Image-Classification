...
model = torch.load(r'model_scripted.pt',map_location=torch.device('cpu'))  # Load your model
model.to(device)

# TEST DATA SET LOCATION
test_dir = r'/kaggle/input/seendatasets/Seen Datasets/val' # THE FOLLOWING TEST IS PERFORMED ON THE PROVIDED VALIDATION SET FROM SEEN DATASET
